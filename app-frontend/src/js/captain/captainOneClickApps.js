angular.module('RDash')
    .factory('captainOneClickApps', function (apiManager) {
        ...
        apps["mySql"] = function (apiManager) {
        ...
        return {
            getTemplate: function (appTemplateId, callback) {
                // instead perform this asynchronously via AJAX call... 
                callback(apps[appTemplateId](apiManager));
            }
        }
