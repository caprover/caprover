...
docker buildx build --platform linux/amd64,linux/arm64,linux/arm,linux/386 -t $IMAGE_NAME:$CAPROVER_VERSION -t $IMAGE_NAME:latest  -f dockerfile-captain.edge --push .